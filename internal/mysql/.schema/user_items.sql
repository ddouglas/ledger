CREATE TABLE `user_items` (
    ...
    `update_type` ENUM('background', 'user_present_required') NOT NULL COLLATE 'utf8mb4_general_ci',
    `investments_update_status` ENUM('success', 'failed') NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
    `investments_update_datetime` DATETIME NULL DEFAULT NULL,
    `transactions_update_status` ENUM('success', 'failed') NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
    `transactions_update_datetime` DATETIME NULL DEFAULT NULL,
    `webhook_status_datetime` DATETIME NULL DEFAULT NULL,
    `webhook_status_code_sent` VARCHAR(32) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
